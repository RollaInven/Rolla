      ...
      <div class="table-responsive">
        <table class="table">
            ...
            <tr>
                <td>
                    ...
                    <input type="number" oninput="checkData(this.value)" name="stok" placeholder="stokbarang" style="color: #000;">
                    <label class="" style="color: #000000; font-size: medium" id="notifStok"></label>
                </td>
            </tr>
            <tr>
                <td>
       ...
       <div class="form-group">
              <!-- <button type="submit" class="btn btn-primary"> Simpan </button>
                    ...
                    <!-- </div> --><!-- /.modal-dialog -->
                <!-- </div> -->
              <!-- <a href="<?php echo base_url()?>BarangMasuk/list_masuk" class="btn btn-md btn-danger"> Kembali </a> -->
...
<input type="hidden" id="stokAwal" name="stokAwal" value="" />
...
<script src="<?php echo base_url().'assets/js/jquery-ui.js'?>" type="text/javascript"></script>
 <script type="text/javascript">
    function checkData(val){
        ...
        if(input > stokAwal){
            document.getElementById('notifStok').innerHTML = "&nbsp Stok Tidak Cukup";
        }else{
            document.getElementById('notifStok').innerHTML = "&nbsp Stok Cukup";
        }
    }
